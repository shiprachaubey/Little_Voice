...
Thank you for contacting us regarding your recent electricity bill...`,
    },
    {
      type: 'seccond',
      content: `Dear [Energy Company Name or Customer Service Team],

I am writing to express my extreme dissatisfaction again...`,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-little-voices-navy text-white flex flex-col md:flex-row">
      ...
      <div className="flex-1 px-4 md:px-10 py-8 md:ml-[120px] w-full max-w-[900px]">
        ...
        <div className="mb-6">
          <label className="block mb-2">AGI Response</label>
          <div className="bg-white text-[#2C3A5F] p-6 rounded-[10px] h-[200px] overflow-y-auto text-sm">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-6">
          <button
            onClick={() => navigate('/home')}
            className="bg-[#ED9A9A] hover:bg-red-400 text-white font-semibold px-6 py-2 text-sm rounded-full flex items-center gap-2"
          >
            <span className="text-white text-lg">✖</span> Close Case
          </button>
          ...
          <button
            onClick={() => navigate('/home')}
            className="bg-[#9AE69A] hover:bg-green-400 text-white font-semibold px-6 py-2 text-sm rounded-full flex items-center gap-2"
          >
            <span className="text-white text-lg">✔</span> Mark As Successful
          </button>
        </div>
        ...
        <div className="mt-12 flex justify-end">
          <img
            src={Logo}
            alt="Little Voices"
            className="w-[80px] md:w-[120px] fixed bottom-4 right-4 z-40"
          />
        </div>
      </div>
    </div>
