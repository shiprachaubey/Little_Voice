...
const Home = () => {
  return (
    <div className="flex bg-little-voices-navy min-h-screen text-white overflow-x-hidden">
      ...
      <div className="ml-0 md:ml-[110px] p-4 md:p-10 w-full">
        {/* Back */}
        {/* <div className="flex items-center gap-2 text-sm text-blue-300 cursor-pointer hover:underline mb-4">
          <FaArrowLeft size={14} />
          <span>Back</span>
        ...
        <section className="mb-12">
          {/* Headings */}
          <div className="hidden md:flex items-center text-sm text-gray-300 mb-3 px-4">
            <div className="md:w-1/2 text-xl font-bold">Business Name</div>
            <div className="md:w-1/4 text-xl font-bold text-center">Date Opened</div>
            <div className="md:w-1/4 text-right"></div>
          </div>
          ...
          <div className="space-y-4">
            {openCases.map((caseItem, idx) => (
              <div
                key={idx}
                className="w-full flex flex-col md:flex-row justify-between items-center gap-2 px-4 py-2 rounded-lg"
              >
                {/* Business Name */}
          ...
          <button className="mt-6 text-sm text-blue-300 hover:underline px-4">+ Add New Case</button>
        </section>

        {/* Closed Cases */}
        <section className="mt-12">
          <div className="flex flex-col md:flex-row md:items-center gap-2 px-4 mb-3">
          ...
          <div className="hidden md:flex items-center text-sm text-gray-300 mb-3 px-4">
            <div className="md:w-1/2 text-xl font-bold">Business Name</div>
            <div className="md:w-1/4 text-xl font-bold text-center">Status</div>
            <div className="md:w-1/4 text-right"></div>
          </div>
            ...
            {[
              ...
              return (
                ...
                >
                  <div className="w-full md:w-1/2">
                    <div
                      className={`px-6 py-3 rounded-full font-semibold text-black text-center md:text-left
                        ${isSuccess ? 'bg-green-400' : 'bg-red-400'}`}
                    >
                      {caseItem.name}
                    </div>
